...
/* - Micran attributes */
#define VI_ATTR_BREAK_PACKET        (0x3FFF0246UL) // Send head and body separately
#define VI_ATTR_FULL_HEAD           (0x3FFF0247UL) // Always show all attributes in packet head
#define VI_ATTR_BODY                (0x3FFF0248UL) // Command body display mode
#define VI_ATTR_SUPPRESS_MICS       (0x3FFF0249UL) // Suppress MICS commands conversion (send & recv data as is)
